...
@jepiq.on(admin_cmd(pattern="المؤسس(?:\s|$)([\s\S]*)"))
async def permalink(mention):
    await edit_or_reply(mention, f"سماحة المؤسس مطور سورس هيرثون @Herthon")
